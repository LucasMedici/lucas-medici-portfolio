...
> = {
  "Java": { icon: <SiJava size={28} />, color: "#007396" },
  ...
  "JPA / Hibernate": { icon: <SiHibernate size={28} />, color: "#59666C" },
  ...
  "YOLO": { icon: <SiYolo size={28} />, color: "#0088CC" },
